...
internal class InitialData
{
    ...
    public static IEnumerable<Product> Products =>
        new List<Product>
        {
            ...
            Product.Create(ProductId.Of(new Guid("63638528-2da5-4097-bc54-0630e2ac9b05")), "IPhone 16", 600)
        };
    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            ...
            var order1 = Order.Create(
                            OrderId.Of(new Guid("14534836-bdbe-4dbe-af1c-80f9d5f433c2")),
                            ...
                            TimeSpan.FromDays(3));
            order1.Add(ProductId.Of(new Guid("5334c996-8457-4cf0-815c-ed2b77c4ff61")), 1, 950);
